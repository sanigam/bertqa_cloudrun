...
def retreiveData():
    queryString = """ SELECT paragraph FROM learn-339101.botdata.paragraph; """
    df = pandas_gbq.read_gbq(queryString, project_id='learn-339101', credentials=credentials)
...
passages_array= [ p['paragraph'] for p in bq_data]
# print(passages_array)
# q = "which college John's sister go"
# print(get_answer (q, passages_array))
